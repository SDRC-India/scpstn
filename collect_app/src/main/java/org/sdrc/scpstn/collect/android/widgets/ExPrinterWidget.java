...
/**
 * <p>Use the SCPS TN Sensors framework to print data to a connected printer.</p>
 *
 ...
 *
 * <p>The SCPS TN Sensors Zebra printer uses this appearance (intent):</p>
 * <pre>
 ...
 *            &lt;value form="noPrinterErrorString"&gt;SCPS TN Sensors Zebra Printer is not installed!
 *             Please install SCPS TN Sensors Framework and SCPS TN Sensors Zebra Printer from Google
 * Play.&lt;/value&gt;
 *          &lt;/text&gt;
 *        &lt;/translation&gt;
 *      &lt;/itext&gt;
