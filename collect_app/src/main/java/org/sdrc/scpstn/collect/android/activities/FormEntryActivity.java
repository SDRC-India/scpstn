...
package org.sdrc.scpstn.collect.android.activities;
...
import org.sdrc.scpstn.collect.android.exception.GDriveConnectionException;
import org.sdrc.scpstn.collect.android.exception.JavaRosaException;
import org.sdrc.scpstn.collect.android.listeners.AdvanceToNextListener;
import org.sdrc.scpstn.collect.android.listeners.FormLoaderListener;
import org.sdrc.scpstn.collect.android.listeners.FormSavedListener;
import org.sdrc.scpstn.collect.android.listeners.SavePointListener;
import org.sdrc.scpstn.collect.android.logic.FormController;
import org.sdrc.scpstn.collect.android.logic.FormController.FailedConstraint;
import org.sdrc.scpstn.collect.android.utilities.TimerLogger;
import org.sdrc.scpstn.collect.android.preferences.AdminKeys;
import org.sdrc.scpstn.collect.android.preferences.AdminPreferencesActivity;
import org.sdrc.scpstn.collect.android.preferences.PreferenceKeys;
import org.sdrc.scpstn.collect.android.preferences.PreferencesActivity;
import org.sdrc.scpstn.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.sdrc.scpstn.collect.android.provider.InstanceProviderAPI;
import org.sdrc.scpstn.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.sdrc.scpstn.collect.android.tasks.FormLoaderTask;
import org.sdrc.scpstn.collect.android.tasks.SavePointTask;
import org.sdrc.scpstn.collect.android.tasks.SaveResult;
import org.sdrc.scpstn.collect.android.tasks.SaveToDiskTask;
import org.sdrc.scpstn.collect.android.utilities.ApplicationConstants;
import org.sdrc.scpstn.collect.android.utilities.FileUtils;
import org.sdrc.scpstn.collect.android.utilities.MediaUtils;
import org.sdrc.scpstn.collect.android.utilities.ToastUtils;
import org.sdrc.scpstn.collect.android.views.ODKView;
import org.sdrc.scpstn.collect.android.widgets.QuestionWidget;
import org.sdrc.scpstn.collect.android.widgets.StringWidget;
...
public class FormEntryActivity extends AppCompatActivity implements AnimationListener,
    ...
    public void loadingComplete(FormLoaderTask task) {
        ...
        // things then
        // returned to SCPS TN and chose Edit Saved Form, but that the
        // savepoint for that
    ...
    private void sendSavedBroadcast() {
        Intent i = new Intent();
        i.setAction("org.sdrc.scpstn.collect.android.FormSaved");
