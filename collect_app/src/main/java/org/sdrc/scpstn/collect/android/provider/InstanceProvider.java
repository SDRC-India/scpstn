...
package org.sdrc.scpstn.collect.android.provider;
...
import org.sdrc.scpstn.collect.android.database.ODKSQLiteOpenHelper;
...
public class InstanceProvider extends ContentProvider {
    ...
    private void deleteAllFilesInDirectory(File directory) {
        if (directory.exists()) {
            ...
            // SCPS TN Tables instance data directory. Let SCPS TN Tables
